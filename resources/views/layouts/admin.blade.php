...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <aside id="admin-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar admin">
            ...
            <ul class="flex-1 space-y-1">
                <li>
                    <a href="{{ route('admin.dashboard') }}" @class([
                        ...
                        'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
                            'admin.dashboard'),
                        'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' => !request()->routeIs(
                            'admin.dashboard'),
                    ])>
                ...
                <li>
                    <a href="{{ route('admin.presensi.index') }}" @class([
                        'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                        'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
                            'admin.presensi.*'),
                        'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' => !request()->routeIs(
                ...
                <li>
                    <a href="{{ route('admin.laporan.index') }}" @class([
                        'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                        'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
                            'admin.laporan.*'),
                        'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' => !request()->routeIs(
                ...
                <li>
                    <a href="{{ route('admin.print-templates.index') }}" @class([
                        'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                        'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
                ...
                <li>
                    <a href="{{ route('admin.panduan') }}" @class([
                        'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                        'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
                            'admin.panduan'),
                        'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' => !request()->routeIs(
                ...
                <li class="pt-4">
                    ...
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.monitoring.activity') }}" @class([
                                'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                                'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
                        ...
                        <li>
                            <a href="{{ route('admin.monitoring.queue') }}" @class([
                                'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors',
                                'bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300' => request()->routeIs(
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-3 mt-3">
                <div class="flex items-center gap-2 px-3 py-2">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" title="Keluar" class="p-1.5 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 transition-colors">
        ...
        <header class="sticky top-0 z-30 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-4 py-3 flex items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-3">
                    <button type="button" data-drawer-target="admin-sidebar" data-drawer-toggle="admin-sidebar" aria-controls="admin-sidebar"
                ...
                {{-- Dark mode toggle --}}
                <button type="button" @click="toggle()" class="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 transition-colors"
